...
- **交互式研究工作台：** 在 GitHub 页面点击 **Code → Download ZIP** 下载并解压整个项目；进入项目根目录后运行 `python -m http.server 8765 --directory web`，再用浏览器访问 [http://127.0.0.1:8765/](http://127.0.0.1:8765/)。请勿只下载 `web/index.html`，网页还需要同目录中的样式、脚本和数据文件。
