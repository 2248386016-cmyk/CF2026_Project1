...
为避免全样本指标掩盖时间稳定性，表\ref{tab:period-performance}按研究阶段单独报告月频基础三因子组合。因子筛选只使用2020--2023研究期和2024验证期，2025在规则冻结后才用于样本外验收。2025样本外累计收益66.58\%，但该结果来自单一年份，不能替代跨市场状态检验；报告同时保留16.18\%最大回撤和21.99\%年化波动，避免只展示收益。

\begin{table}[H]\centering\small
\caption{基础三因子组合的分阶段扣费绩效}\label{tab:period-performance}
\begin{tabular}{lrrrr}
\toprule 阶段 & 累计收益 & 年化收益 & 年化波动 & 最大回撤\\\midrule
研究期（2020--2023） & 163.91\% & 27.39\% & 19.13\% & 27.60\%\\
验证期（2024） & 1.99\% & 1.99\% & 33.90\% & 29.63\%\\
冻结样本外（2025） & 66.58\% & 66.23\% & 21.99\% & 16.18\%\\\bottomrule
\end{tabular}
\end{table}
